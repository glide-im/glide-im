...
type UpdateGroupRouteRequest struct {
...
func (x *UpdateGroupRouteRequest) Reset() {
	*x = UpdateGroupRouteRequest{}
...
func (x *UpdateGroupRouteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateGroupRouteRequest) ProtoMessage() {}

func (x *UpdateGroupRouteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_broker_proto_msgTypes[0]
...
// Deprecated: Use UpdateGroupRouteRequest.ProtoReflect.Descriptor instead.
func (*UpdateGroupRouteRequest) Descriptor() ([]byte, []int) {
	return file_broker_proto_rawDescGZIP(), []int{0}
}

func (x *UpdateGroupRouteRequest) GetGid() int64 {
	if x != nil {
		return x.Gid
	}
	return 0
...
func (x *UpdateGroupRouteRequest) GetRoute() string {
	if x != nil {
		return x.Route
	}
	return ""
...
var file_broker_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x2e, 0x67, 0x6c, 0x69, 0x64, 0x65, 0x22, 0x41, 0x0a, 0x17, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x67, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x03, 0x67, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x42, 0x1b, 0x5a, 0x19,
...
var file_broker_proto_goTypes = []interface{}{
	(*UpdateGroupRouteRequest)(nil), // 0: pro.glide.UpdateGroupRouteRequest
}
...
func file_broker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_broker_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateGroupRouteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
